...
\definecolor{3ClassSet1_1}{rgb}{0.894118,0.101961,0.109804}
\definecolor{3ClassSet1_2}{rgb}{0.215686,0.494118,0.721569}
\definecolor{3ClassSet1_3}{rgb}{0.301961,0.686275,0.290196}
...
\begin{frame}
    ...
    \begin{tikzpicture}
        \begin{semilogyaxis}[
            ...
            \addplot[3ClassSet1_1] table {../Text/CSV/lambdas/ED7AA2-eigenvalue-01-fit.csv};
            \addplot[3ClassSet1_2] table {../Text/CSV/lambdas/ED7AA2-eigenvalue-03-fit.csv};
            \addplot[3ClassSet1_3] table {../Text/CSV/lambdas/ED7AA2-eigenvalue-05-fit.csv};
            \addplot[
                3ClassSet1_1,
                only marks,
                mark=|,
...
\begin{frame}
    \frametitle{$E_0$ in Abhängigkeit von $\timestep$ und $\gausswidth$}
