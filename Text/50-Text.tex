...
Die Weltlinie wird in der Regel anfangs mit zufälligen Werten für die $x_j$
aus dem Intervall $(-\initialrandomwidth, \initialrandomwidth)$ oder mit 0
initialisiert. Bevor Werte aufgenommen werden, durchläuft das System
$\preiterations$ Monte-Carlo-Iterationen (meist \numrange{50}{2000}) zur
Relaxation. Danach sieht die Weltlinie wie in Abbildung~\ref{fig:relaxiert}
aus. Für beide Arten der Initialisierung werden nach der Relaxation
gleichartige Zustände erreicht.
