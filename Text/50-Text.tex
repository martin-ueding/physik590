...
\begin{figure}[htbp]
    ...
    \begin{tikzpicture}
        \begin{axis}[
            ...
            \addplot[black!100!white] table {CSV/-1/a-E0-fit-0.01.csv};
            \addplot[black!100!white] table {CSV/-1/a-E0-fit-0.05.csv};
            \addplot[black!100!white] table {CSV/-1/a-E0-fit-0.1.csv};
            \addplot[black!100!white] table {CSV/-1/a-E0-fit-0.2.csv};
            \addplot[black!100!white] table {CSV/-1/a-E0-fit-0.3.csv};
            \addplot[black!100!white] table {CSV/-1/a-E0-fit-0.4.csv};
            \addplot[black!100!white] table {CSV/-1/a-E0-fit-0.5.csv};
            \addplot[black!100!white] table {CSV/-1/a-E0-fit-0.7.csv};
            \addplot[black!100!white] table {CSV/-1/a-E0-fit-1.0.csv};
            \addplot[
                black!100!white,
                only marks,
                mark=|,
...
\begin{figure}[htbp]
    ...
    \begin{tikzpicture}
        \begin{axis}[
            ...
            \addplot[black!100!white] table {CSV/-1/a-E0-meta-fit-0.3.csv};
            \addplot[
                black!100!white,
                only marks,
                mark=|,
