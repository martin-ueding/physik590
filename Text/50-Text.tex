...
$E_1$ bestimmen. Energien für noch höhere Zustände können mit dem „Generalized
Eigenvalue Problem“ (GEVP) errechnet werden.
...
\[
    E_n^\text{eff}(\tau, \tau_0) = - \partial_\tau \ln\del{\lambda_n(t, \tau_0)} \equiv -
    \frac 1\timestep \sbr{ \ln\del{\lambda_n(t+\timestep, \tau_0)} -
...
\parencite[5]{Blossier/Eigenvalue}. Daher wähle ich in meiner Implementierung
$\tau_0 := \tau/2$.
