...
% TODO Einleitung verfassen.

In der Physik gibt es viele Probleme, die nicht analytisch gelöst werden
...
werden. Diese werden als gegeben vorausgesetzt und nicht unbedingt explizit
zitiert.
...
als $- [\vnabla V] \vec r$ geschrieben werden. In einer Dimension ist das, wie
in \parencite[(2.29)]{Creutz/Statistical_Approach_QM},
\[
...
\[
    ...
    = \mu^2 \bracket{x^2},
\]
wie auch in \parencite[(4.13)]{Creutz/Statistical_Approach_QM} benutzt.
...
Vorraussetzung ist, dass $\tens B$ positiv definit ist, was hier der Fall ist.
...
Dies setze ich (analog zu \br5) in die \textsc{Schrödinger}gleichung
\eqref{eq:Bus_3} ein:
\[
...
Abbildung~\ref{fig:gausspotential} enthält das Potential für eine
negative und positive Kopplungsstärke $1/a_0$.
...
$\initialrandomwidth = \num{0}$. Ebenfalls wurde immer $\margin = 2
...
$\timestep$ ebenfalls. Diesen Effekt konnte ich auch für den harmonischen
Oszillator beobachten, es ist also unabhängig von der Störung.
