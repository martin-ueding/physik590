...
können. Bei einigen von ihnen lässt sich das Problem in ein analytisch lösbaren
Teil und einen kleinen Störteil aufteilen. Die Störungstheorie versagt jedoch
bei Theorien wie der Quantenchromodynamik (QCD), so dass nur noch numerische
Methoden anwendbar sind \parencite{Wittig/Farbdynamik_Gitter}.
