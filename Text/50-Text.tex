...
\ref{fig:77130C-eigenwerte-ungerade} bzw. \ref{fig:77130C-eigenwerte-gerade}
dargestellt. Mit dem Virialsatz erhalte ich $E_0 = \num{0.4989 +- 0.0002}$. Mit
der einfachen Korrelation $C_{11}(t)$ erhalte ich $E_1 = \num{1.50387 +-
0.00070}$. Die Energiewerte aus der Anpassung des GEVP sind in
Tabelle~\ref{tab:77130C-eigenwerte} aufgelistet.

\begin{figure}[htbp]
    \centering
    \tikzsetnextfilename{77130C-eigenwerte-ungerade}
    \begin{tikzpicture}
        \begin{semilogyaxis}[
                width=\linewidth,
                height=0.55\linewidth,
            ...
            \addplot[black!100!white] table {CSV/lambdas/77130C-eigenvalue-01-fit.csv};
            \addplot[black!60!white] table {CSV/lambdas/77130C-eigenvalue-03-fit.csv};
            \addplot[black!30!white] table {CSV/lambdas/77130C-eigenvalue-05-fit.csv};
            \addplot[
                black!100!white,
                only marks,
                mark=|,
                ...
                y dir=both,
                y explicit
            ] table[y error index=2] {CSV/lambdas/77130C-eigenvalue-01.csv};
            \addplot[
                black!60!white,
                only marks,
                mark=|,
                ...
                y dir=both,
                y explicit
            ] table[y error index=2] {CSV/lambdas/77130C-eigenvalue-03.csv};
            \addplot[
                black!30!white,
                only marks,
                mark=|,
                ...
                y dir=both,
                y explicit
            ] table[y error index=2] {CSV/lambdas/77130C-eigenvalue-05.csv};
        \end{semilogyaxis}
    \end{tikzpicture}
    \caption{%
    ...
    \label{fig:77130C-eigenwerte-ungerade}
\end{figure}

\begin{figure}[htbp]
    \centering
    \tikzsetnextfilename{77130C-eigenwerte-gerade}
    \begin{tikzpicture}
        \begin{semilogyaxis}[
                width=\linewidth,
                height=0.55\linewidth,
            ...
            \addplot[black!100!white] table {CSV/lambdas/77130C-eigenvalue-02-fit.csv};
            \addplot[black!60!white] table {CSV/lambdas/77130C-eigenvalue-04-fit.csv};
            \addplot[black!30!white] table {CSV/lambdas/77130C-eigenvalue-06-fit.csv};
            \addplot[
                black!100!white,
                only marks,
                mark=|,
                ...
                y dir=both,
                y explicit
            ] table[y error index=2] {CSV/lambdas/77130C-eigenvalue-02.csv};
            \addplot[
                black!60!white,
                only marks,
                mark=|,
                ...
                y dir=both,
                y explicit
            ] table[y error index=2] {CSV/lambdas/77130C-eigenvalue-04.csv};
            \addplot[
                black!30!white,
                only marks,
                mark=|,
                ...
                y dir=both,
                y explicit
            ] table[y error index=2] {CSV/lambdas/77130C-eigenvalue-06.csv};
        \end{semilogyaxis}
    \end{tikzpicture}
    \caption{%
    ...
    \label{fig:77130C-eigenwerte-gerade}
\end{figure}
